...
namespace WPFTestResults
{
    ...
    public partial class ChangeExecuteBulkData : Window
    {
        /// <summary>
        ...
        public ChangeExecuteBulkData(string bestandsnaamopen = "")
        {
            var bestandsnaam = bestandsnaamopen;
            InitializeComponent();
        ...
        private void ButtonDeleteClick(object sender, RoutedEventArgs e)
        {
            ...
            General.LogMessage(
                "Query for execution settings: '" + deleteString + "'.",
                3,
                string.Empty,
                0,
                string.Empty,
            ...
            catch (Exception ex)
            {
                General.LogMessage(
                    ...
                    InloggerData.MachineCode);
                MessageBox.Show(
                    "Selected TestSteps are NOT changed for execution from the database!!!",
                    "Message",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
            }
            ...
            {
                MessageBox.Show(
                    "Selected TestSteps are changed for execution from the database!!!",
                    "Message",
                    MessageBoxButtons.OK,
