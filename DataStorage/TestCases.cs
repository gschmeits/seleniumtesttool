    ...
    public static class TestCases
    {
            ...
            string test_password = "")
        {
            try
            {
                ...
                General.LogMessageDatabase(commandText, 1);
            }
            catch (Exception e)
            {
        ...
        public static void AddTestResults(string testrun_application, string testrun, string testpassed, string testfailed, DateTime begin,
            DateTime eind, string tijd, string browserid, string version1, string machinenumber, string start_url, string testscenario_name)
        {
            try
            {
